package com.yjx.node.service;

import cn.hutool.core.util.StrUtil;
import com.yjx.node.dao.NoteDao;
...
public class NoteService {
     ...
     * @return
     */
    public Integer noteDetlete(String noteId) {
        //判断参数
        if (StrUtil.isBlank(noteId)){
            return 0;
        }
     ...
     * @return
     */
    public ResultInfo<Map<String, Object>> quertNoteCountByMonth(Integer userId) {
