...
public class BaseDao {
    ...
    public static int executeUpdate(String sql, List<Object> params){
        int row =0;//受影响的行数
        Connection connection = null ; //获取数据库的链接
        PreparedStatement preparedStatement = null; //预编译
     ...
     * 查询对象
     */
    public static Object quertRow(String sql,List<Object> params,Class cls){
