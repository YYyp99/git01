...
<div class="container">
            ...
            <div class="data_list">
                ...
                <div>
                    <ul class="nav nav-pills nav-stacked" id="typeUl">
                        ...
                        <li id="li_${item.typeId}"><a href="index?actionName=serchType&typeId=${item.typeId}"><span id="sp_${item.typeId}">${item.groupName}</span> <span class="badge">${item.noteCount}</span></a></li>
    ...
    <%--动态包含页面--%>
    <%--云记列表--%>
    <%--<jsp:include page="node/list.jsp"></jsp:include>--%>
    <%--个人中心--%>
    <%--<jsp:include page="user/info.jsp"></jsp:include>--%>
    <%--类型列表--%>
    <%--<jsp:include page="type/list.jsp"></jsp:include>--%>
    <%--通过后台设置的动态显示的页面，通过包含加载进来--%>
    <%--如果获取到后台设置的值，则显示，如果未获取到，则显示默认--%>
